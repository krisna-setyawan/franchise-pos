<div class="page-wrapper">
	<div class="content">
		...
		<div class="card">
			<div class="card-body">
				<form autocomplete="off" class="row needs-validation" novalidate action="<?= base_url() ?>inbound/update" method="post">
					<input type="hidden" name="id_inbound" value="<?= $inbound['id'] ?>">
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Nomor</label>
							<input readonly style="background: #fff;" class="form-control" required id="nomor" name="nomor" type="text" value="<?= $inbound['nomor'] ?>">
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Tanggal</label>
							<input class="form-control" required id="tanggal" name="tanggal" type="text" value="<?= $inbound['tanggal'] ?>">
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Asal</label>
							<input class="form-control" required id="asal" name="asal" type="text" value="<?= $inbound['asal'] ?>">
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Keterangan</label>
							<input class="form-control" required id="keterangan" name="keterangan" type="text" value="<?= $inbound['keterangan'] ?>">
						</div>
					</div>
							...
							<div class="table-responsive">
								<table class="table" style="background-color: #FAFBFE;">
									...
									<tbody id="TBody">
										...
										<?php
										$no = 1;
										foreach ($inbound_detail as $list) { ?>
											<?php $no_baris = $no++ ?>
