<div class="page-wrapper">
	<div class="content">
		...
		<div class="card">
			<div class="card-body">
				<form class="row needs-validation" novalidate action="<?= base_url() ?>inbound/store" method="post">
									...
									<tbody id="TBody">
										<tr id="TRow_0" class="d-none">
											<td>
												...
												<input autocomplete="off" class="form-control" type="text" name="nama_produk[]" id="nama_produk_0" onclick="select_produk()">
											</td>
											<td>
...
<script>
	...
	function pilih_produk(id_produk, nama_produk) {
		var rowCounterOld = rowCounter - 1;
		$('#id_produk_' + rowCounterOld).val(id_produk)
		$('#nama_produk_' + rowCounterOld).val('asd')
		$('#mymodal').modal('hide');
	}
</script>
