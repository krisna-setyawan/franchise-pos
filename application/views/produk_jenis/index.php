<div class="page-wrapper">
	<div class="content">
		...
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="<?= base_url() ?>produk_jenis/add" class="btn btn-added"><img src="<?= base_url() ?>assets/template/assets/img/icons/plus.svg" alt="img">Tambah Jenis Produk</a>
			</div>
		</div>
							...
							<?php foreach ($produk_jenis as $dt) : ?>
								<tr>
									...
									<td class="text-center">
										<a class="me-3" href="<?= base_url() ?>produk_jenis/edit/<?= $dt->id ?>">
											<img src="<?= base_url() ?>assets/template/assets/img/icons/edit.svg" alt="img">
										</a>
										<a class="me-3" href="javascript:void(0);" onclick="confirm_delete('<?= base_url() ?>produk_jenis/delete/<?= $dt->id ?>')">
