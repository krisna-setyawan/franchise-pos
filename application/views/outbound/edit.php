<div class="page-wrapper">
	<div class="content">
		...
		<div class="card">
			<div class="card-body">
				<form autocomplete="off" class="row needs-validation" novalidate action="<?= base_url() ?>outbound/update" method="post">
					<input type="hidden" name="id_outbound" value="<?= $outbound['id'] ?>">
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Nomor</label>
							<input readonly style="background: #fff;" class="form-control" required id="nomor" name="nomor" type="text" value="<?= $outbound['nomor'] ?>">
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Tanggal</label>
							<input class="form-control" required id="tanggal" name="tanggal" type="text" value="<?= $outbound['tanggal'] ?>">
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Tujuan</label>
							<input class="form-control" required id="tujuan" name="tujuan" type="text" value="<?= $outbound['tujuan'] ?>">
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="form-group">
							<label>Keterangan</label>
							<input class="form-control" required id="keterangan" name="keterangan" type="text" value="<?= $outbound['keterangan'] ?>">
						</div>
					</div>
								...
								<table class="table" style="background-color: #FAFBFE;">
									...
									<tbody id="TBody">
										<tr id="TRow_0" class="d-none">
											...
											<td>
												<input autocomplete="off" class="form-control" type="number" name="qty[]" id="qty_0">
											</td>
											<td>
										...
										<?php
										$no = 1;
										foreach ($outbound_detail as $list) { ?>
											<?php $no_baris = $no++ ?>
											<tr id="TRow_<?= $no_baris ?>">
												<td>
													...
													<input readonly autocomplete="off" style="background: #fff;" class="form-control" type="text" name="nama_produk[]" id="nama_produk_<?= $no_baris ?>" onclick="select_produk(this)" value="<?= $list->nama_produk ?>">
												</td>
												<td>
													<input autocomplete="off" class="form-control" type="number" name="qty[]" id="qty_<?= $no_baris ?>" value="<?= $list->qty ?>">
												</td>
												<td>
													<a class="delete-set" onclick="BtnDel(this)"><img src="<?= base_url() ?>assets/template/assets/img/icons/delete.svg" alt="svg"></a>
												</td>
